    ...
    <div>
      <div className="today">
        ...
        {width > 950 ?
          ...
          <div className="details">
            <div className="detail min" style={detailStyle}>
              <div>
                <svg width="24" height="24" viewBox="0 0 24 24">
                  <path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z" stroke="#023e8a"></path>
                </svg>
            ...
            <div className="detail max" style={detailStyle}>
              <div>
                <svg width="24" height="24" viewBox="0 0 24 24">
                  <path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z" stroke="#f25c54"></path>
                </svg>
            ...
            <div className="detail sunrise" style={detailStyle}>
              <div>
                <svg width="24" height="24" viewBox="0 0 24 24">
                  <path d="M17 18a5 5 0 0 0-10 0" stroke="#ffdd00"></path>
                  <line x1="12" y1="2" x2="12" y2="9"></line>
            ...
            <div className="detail sunset" style={detailStyle}>
              <div>
                <svg width="24" height="24" viewBox="0 0 24 24">
                  <path d="M17 18a5 5 0 0 0-10 0" stroke="#ffdd00"></path>
                  <line x1="12" y1="9" x2="12" y2="2"></line>
            ...
            <div className="detail wind-speed" style={detailStyle}>
              <div>
                <svg width="24" height="24" viewBox="0 0 24 24">
                  <path d="M9.59 4.59A2 2 0 1 1 11 8H2m10.59 11.41A2 2 0 1 0 14 16H2m15.73-8.27A2.5 2.5 0 1 1 19.5 12H2"></path>
                </svg>
            ...
            <div className="detail wind-direction" style={detailStyle}>
              <div>
                <svg width="24" height="24" viewBox="0 0 24 24" style={dirStyle}>
                  <polygon points="12 2 19 21 12 17 5 21 12 2"></polygon>
                </svg>
